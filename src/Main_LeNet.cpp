...
//    string file_addr = "../MnistData/TrainImg";
    string file_addr = "../MnistData/MNIST100";
    // 批量读取图片
    cout<<"Reading training begins"<<endl;
    read_batch_images(file_addr, "bmp", 0, 99, train_x_Mat);
...
//    train_y.show_image_64FC1(700);
    ...
    input_layer_1.type = 'i'; input_layer_1.iChannel = 1; input_layer_1.iSizePic[0] = 28; input_layer_1.iSizePic[1] = 28;
