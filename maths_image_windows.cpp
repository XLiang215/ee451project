...
void vector_Mat_64FC1_show_one_window(const std::string& MultiShow_WinName, const vector<cv::Mat>& SrcImg_V, Size SubPlot, Size ImgMax_Size, int time_msec)
{
	...
	//=================== Size for Window ===================//
	// CV_8UC3:8λ��ͨ����ͼ0~256   CV_64FC1��64λ��ͨ���Ҷ�ͼ0~1
...
//	int Scree_H = GetSystemMetrics(SM_CYSCREEN);
	...
	waitKey(time_msec);
	destroyWindow(MultiShow_WinName.c_str());
}


// �������ͨ����ͼ�����һ��ͼ�����matlab��subplot
...
// �����array2D�����һ��ͼ�����matlab��subplot�� ע�⣬����Ӧ����֤array2D��ֵ����0~1֮��
